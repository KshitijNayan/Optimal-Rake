...
export default function Announcements() {
    ...
    return(
        <>
            <h2 className='mx-4' style={{color:'black', paddingTop:is7Wide?'80px':'50px', paddingLeft:'5%' }}>New Announcements</h2>
            ...
            <h2 className='mx-4' style={{color:'black', paddingLeft:'5%'}}>Previous announcements</h2>
